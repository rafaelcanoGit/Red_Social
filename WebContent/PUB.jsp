...
<section id="seccionPublicacion">
	
  <div id="publicacion" class="row">

<img id="imgP" class="img-responsive" src="${nombreP}">
<textarea id="textComentario" placeholder="Comentar" > </textarea> <input id="botonComentar" type="button" name="botonComentar" value="Comentar">
